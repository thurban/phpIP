...
define('NODE_DEFAULT_IMG','/i/folder_win.gif');
define('LEAF_DEFAULT_IMG','/i/document_win.gif');
define('NODE_DEFAULT_ALT_IMG','/i/folder_win_o.gif');
define('LEAF_DEFAULT_ALT_IMG','/i/document_win_o.gif');
